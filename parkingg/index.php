...
if(isset($_GET["insertar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"INSERT INTO empleados(tipo,placas) VALUES('$tipo','$placas') ");
    echo json_encode(["success"=>1]);
        }
    exit();
}
...
if(isset($_GET["actualizar"])){
    ...
    $sqlEmpleaados = mysqli_query($conexionBD,"UPDATE empleados SET tipo='$tipo',placas='$placas' WHERE id='$id'");
    echo json_encode(["success"=>1]);
    exit();
}
